...
<div class="ui left fixed vertical labeled icon menu rmt_feature_menu">
    <div id="${session_name}-login_menu_button" class="item active" data-tab="${session_name}-login">
        <i class="sign in icon"></i>
        Login
    </div>
    <div id="${session_name}-term_menu_button" class="item disabled" data-tab="${session_name}-terminal">
        <i class="terminal icon"></i>
        Terminal
    </div>
    <div id="${session_name}-tf_menu_button" class="item disabled" data-tab="${session_name}-transfer">
